...
- [ ] Verfügbare 100 K-Varianten verifizieren (manchmal nur 15 K im aktuellen Release)
- [ ] OAEI-Datensatz-Format prüfen (OWL/XML vs. RDF/XML)
- [ ] Sampling-Skript für #8 entwerfen — eigenes Mini-Konzept
